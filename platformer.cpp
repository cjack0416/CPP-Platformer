...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCMDLine, int nShowCmd)
{
    ...
    // Create Window
    HWND window = CreateWindowA(window_class.lpszClassName, "First Platformer", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, 1280, 720, 0, 0, hInstance, 0);
    // {
    //     //Fullscreen
